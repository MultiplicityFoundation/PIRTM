...
- All associated proofs, lemmas, corollaries, and theorems

### Ethical & Governance Layer
- Conscious Sovereignty Layer (CSL) operators and formalism
- Silence Clause principles
- Ξ-Constitution (full text and amendments)
- Prime-Lawful Ivariant Contract (PLIC)

### Protocol Specifications
- RootContract interface specification
- Λ-Archivum audit log schema
- Prime-gated activation protocol
- Drift-bound enforcement formulas
- Nullifier construction methods
...
## 3. Permissionless Innovation Guarantee
...
These publications do NOT limit third parties' ability to patent their own
novel implementations or workflows.
...
|----------|-----------|---------|
| Patent domain-specific workflows | ✓ YES | Healthcare consent management system using MTPI |
...
This pledge's non-assertion covenant terminates ONLY if a third party:

(a) Asserts patents against the Constitutional Core itself (not their own
    tools, but the foundational MTPI/CSL/PIRTM mathematics); OR

(b) Asserts patents to prevent others from implementing the Constitutional
    Core specifications.
