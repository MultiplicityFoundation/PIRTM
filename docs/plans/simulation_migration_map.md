...
|---|---|---|---|
| `src/pirtm/simulations/qari_module.py` | `PrimeTensorSystem`, `recursive_update`, `analyze_tensor` | Legacy-backed (non-core) | **Migrate** to core recurrence + spectral APIs |
...
| `src/pirtm/simulations/riemann_verification.py` | `PrimeTensorSystem`, `analyze_tensor` | Legacy-backed research simulation | **Classify** as legacy/research until generator replacement exists |
