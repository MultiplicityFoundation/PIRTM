...
class PrimeTensorSystem:
    ...
    def __init__(self, dim=3, num_primes=100, seed=None):
        ...
        self.primes = list(primerange(2, nextprime(num_primes * 10)))
        self.state = seed if seed is not None else np.eye(dim)
